...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{variances }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(GK\_PCA)}\SpecialCharTok{$}\NormalTok{importance[}\DecValTok{2}\NormalTok{,]}
\FunctionTok{barplot}\NormalTok{(variances, }\AttributeTok{main =} \StringTok{"Variance expliquée par chaque composante principale"}\NormalTok{, }\AttributeTok{col =} \StringTok{"lightblue"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Composantes principales"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Proportion de variance"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
